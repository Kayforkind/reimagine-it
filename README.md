...
![one raw Texas notebook, eight content-aware redesigns: default, artistic, dashboard, photography, cinematic, cinematic+glassmorphism, dashboard+bento, landing+neon](gold/gallery.png?v=texas-3)
...
![default spine before/after: raw Texas notebook on the left, redesigned page on the right](gold/webpage/compare.png?v=texas-3)
...
![artistic pack before/after: raw HTML on the left, italic-serif editorial redesign of the Texas notebook on the right](gold/domains/artistic/compare.png?v=texas-3)
...
![dashboard pack before/after: raw HTML on the left, ops-surface dashboard for the Texas notebook on the right](gold/domains/dashboard/compare.png?v=texas-3)
...
![photography pack before/after: raw HTML on the left, Didot magazine folio of the Texas notebook on the right](gold/domains/photography/compare.png?v=texas-3)
...
![cinematic pack before/after: raw HTML on the left, WebGL2 Texas-sunset shader hero on the right](gold/domains/cinematic/compare.png?v=texas-3)
...
![cinematic + glassmorphism before/after: raw HTML on the left, two glass tiers over a running Texas sunset on the right](gold/modifiers/cinematic-glassmorphism/compare.png?v=texas-3)
...
![dashboard + bento before/after: raw HTML on the left, nine-tile bento of the Texas notebook with elevated 2x2 hero on the right](gold/modifiers/dashboard-bento/compare.png?v=texas-3)
...
![landing + neon before/after: raw HTML on the left, one glowing sun-gold star in a dark void on the right](gold/modifiers/landing-neon/compare.png?v=texas-3)
...
![motion strip: four packs, three frames each](gold/domains/motion-strip.png?v=texas-3)
