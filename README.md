...
Live captures. Not stories. Suite exit `0` (`failed=0`). Re-run: `python gold/five/run.py`. The suite badge below and the skyline in example 3 are rewritten by that same run.
...
gold/five/              # five fixtures; python gold/five/run.py
