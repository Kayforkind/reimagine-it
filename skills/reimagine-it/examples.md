...
Visual proof starts with the static [method illustration](../../docs/hero.svg) and the [five-form strip](../../gold/forms/strip.png). For motion, open the [live form gallery](../../gold/forms/see.html); motion is verified in the artifact, not flattened into a GIF in the README.
