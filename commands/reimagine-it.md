---
description: >-
  From current context, invent a leap they did not know to ask for — feature,
  CLI, protocol, demo, architecture, prose, or visual. Vastness and sensation.
  Not a mood-word list. Same chair as /reimagine-it.
---

# /reimagine-it — invent a leap from context

Load and follow the installed **reimagine-it** skill (`SKILL.md`). Also `references/notes.md`, `references/forms.md`, `examples.md`.

Copy this file to `~/.cursor/commands/reimagine-it.md` if you want the slash in Cursor.
